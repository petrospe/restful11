...
$.ajax({
    ...
    success: function (response) {
        ...
        $.each(response, function (i, item) {
            divHTML += '<div class="col-xs-18 col-sm-6 col-md-4"><div class="thumbnail"><img src="' + imagepathurl + item.image + '" name="image" class="img-responsive img-rounded"> <div class="caption"><h4 class="title" name="title">' + item.title + '</h4> <p class="more" name="description">' + item.description + '</p><a href="#"  id='+item.id+' class="btn btn-default btn-xs pull-right edit-project" role="button"><i class="glyphicon glyphicon-edit"></i></a><a href="#" class="btn btn-info btn-xs" role="button">Tasks</a></div></div></div>';
        });
